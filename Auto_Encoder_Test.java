...
public class Auto_Encoder_Test extends LinearOpMode {
    ...
    static final double     COUNTS_PER_INCH         = (COUNTS_PER_MOTOR_REV_DT * DRIVE_GEAR_REDUCTION) /
            (WHEEL_RADIUS_INCHES * 3.1415);
    ...
    public void runOpMode() {
        ...
        if (sleeveDetection.getPosition().equals(SleeveDetection.ParkingPosition.LEFT)) {
            Claw.setPosition(1);
            encoderDrive(DRIVE_SPEED, 24, 24, 24, 24, 2);  // S1: Forward 24 Inches with 2 Sec timeout
            encoderDrive(TURN_SPEED, 3.5, -3.5, 3.5, -3.5, 2);  // S2: Turn Right 3.5 Inches with 2 Sec timeout
            //Set Lift to Position
            Lift.setTargetPosition(LIFT_LEVEL_THREE);
            Lift.setPower(1);
            Lift.setMode(DcMotor.RunMode.RUN_TO_POSITION);
            sleep(1000);
            encoderDrive(DRIVE_SPEED, 4, 4, 4, 4, 1);  // S3: Forward 4 inches with 1 sec timeout
            ...
            sleep(1000);
            encoderDrive(DRIVE_SPEED, -14, -14, -14, -14, 2);
            encoderDrive(TURN_SPEED, 13, -13, 13, -13, 2);
            Lift.setPower(1);
            sleep(700);
            encoderDrive(DRIVE_SPEED, 3.5, 3.5, 3.5, 3.5, 1);
            Claw.setPosition(0.6);
            sleep(1000);
